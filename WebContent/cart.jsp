...
<%
	List<Products> listP =(List<Products>) request.getSession().getAttribute("listCart");
%>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="productList.jsp">Shop page</a></li>
                        ...
                        <div class="woocommerce">
                            <form method="post" action="cartController">
                                <table cellspacing="0" class="shop_table cart">
                                    ...
                                    <input type="hidden" name="total" value="${item.quantity*item.price}"/>
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="cartController?action=remove&code=${item.code}">×</a> 
                                            </td>

                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="getImage.jsp?code=${item.code}"></a>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    <input type="button" class="minus" value="-" onclick="changeValue(this)">
                                                    <input type="number" size="4" class="input-text qty text" id="quantity-number" name="quantity" title="Qty" value="${item.quantity }" min="0" step="1">
                                                    <input type="button" class="plus" value="+" onclick="changeValue(this)">
													
													<script>
														function changeValue(obj){
															if(obj.value=="+"){
																document.getElementById("quantity-number").value = Number(document.getElementById("quantity-number").value)+Number(1);
															}else{
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                ...
                                                <input type="submit" value="Checkout" name="action" class="checkout-button button alt wc-forward">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
