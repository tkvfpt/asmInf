...
<body>
                    ...
                    <div class="header-right">
                        ...
                        <%if(session.getAttribute("user")!=null){ %>
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">${sessionScope.user}</span><span class="value"> </span><b class="caret"></b></a>
  ...
  <span style="color:red">${requestScope.error }</span>
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" name="fullname" class="form-control" id="fn">
	  </div>
    ...
    <label class="radio-inline">
	  ...
	  <button type="submit" name="action" value="Signup" class="btn btn-default">Login</button>
	</form>
  </div>
</div>
