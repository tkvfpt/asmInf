...
List<Products> listP;
	try{
	hb.beginTransaction();
	 listP=hb.getEntity("Products",0,5);
	hb.commitTransaction();
	}finally{
		hb.closeTransaction();
	}
%>
<c:set var="listP" value="<%=listP %>"/> 
<body>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    %>
                        ...
                        <a href="cart.jsp">Cart - <span class="cart-amunt">£<%=sumPrice%></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><%=listCart.size() %></span></a>
                        <%}else{%>
	                            ...
	                            <div class="single-product">
	                                <div class="product-f-image">
	                                    ...
	                                    <div class="product-hover">
	                                        <a href="indexController?action=AddToCart&product-code=${item.code}" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
	                        				
	                                        <!-- <input type="submit" name="action" style="display:none" id="btnAddToCart" value="AddToCart"/> onclick="activateSubmitBtn()"-->
	                                ...
	                                <div class="product-carousel-price">
	                                    <ins>${item.price}</ins> <del>$10000.00</del>
	                                </div> 
	                            </div>
